...
class CAR(StrEnum):
  ...
  KIA_CEED_SW_PHEV_2022_NON_SCC = "KIA CEED SW PHEV 2022 NON-SCC"
...
CAR_INFO: dict[str, HyundaiCarInfo | list[HyundaiCarInfo] | None] = {
  ...
  CAR.KIA_CEED_SW_PHEV_2022_NON_SCC: HyundaiCarInfo("Kia Ceed Sportswagon PHEV 2022", "No Smart Cruise Control (SCC)", car_parts=CarParts.common([CarHarness.hyundai_i])),
...
CANFD_CAR = {CAR.KIA_CEED_SW_PHEV_2022_NON_SCC, CAR.KIA_EV6, CAR.IONIQ_5, CAR.IONIQ_6, CAR.TUCSON_4TH_GEN, CAR.SANTA_CRUZ_1ST_GEN, CAR.KIA_SPORTAGE_5TH_GEN, CAR.GENESIS_GV70_1ST_GEN,
...
HYBRID_CAR = {CAR.IONIQ_PHEV, CAR.KIA_CEED_SW_PHEV_2022_NON_SCC, CAR.ELANTRA_HEV_2021, CAR.KIA_NIRO_PHEV, CAR.KIA_NIRO_HEV_2021, CAR.SONATA_HYBRID, CAR.KONA_HEV, CAR.IONIQ,
...
LEGACY_SAFETY_MODE_CAR = {CAR.HYUNDAI_GENESIS, CAR.IONIQ_EV_LTD, CAR.KIA_OPTIMA_G4,
                          CAR.VELOSTER, CAR.GENESIS_G70, CAR.GENESIS_G80, CAR.KIA_CEED,
                          CAR.ELANTRA, CAR.IONIQ_HEV_2022, CAR.KIA_OPTIMA_H, CAR.ELANTRA_GT_I30}

# these cars have not been verified to work with longitudinal yet - radar disable, sending correct messages, etc.
UNSUPPORTED_LONGITUDINAL_CAR = LEGACY_SAFETY_MODE_CAR | {CAR.KIA_CEED_SW_PHEV_2022_NON_SCC, CAR.KIA_NIRO_PHEV, CAR.KIA_SORENTO, CAR.SONATA_LF, CAR.KIA_OPTIMA_G4_FL,
                                                         CAR.KIA_OPTIMA_H_G4_FL}

NON_SCC_CAR = {CAR.KIA_CEED_SW_PHEV_2022_NON_SCC, CAR.KIA_FORTE_2021_NON_SCC, CAR.ELANTRA_2022_NON_SCC, CAR.KIA_FORTE_2019_NON_SCC, CAR.GENESIS_G70_2021_NON_SCC,
