...
def create_lkas11(packer, frame, car_fingerprint, apply_steer, steer_req,
  ...
  if car_fingerprint in (CAR.SONATA, CAR.PALISADE, CAR.KIA_NIRO_EV, CAR.KIA_NIRO_HEV_2021, CAR.SANTA_FE,
                         ...
                         CAR.SANTA_FE_PHEV_2022, CAR.KIA_STINGER_2022, CAR.KIA_K5_HEV_2020, CAR.KIA_CEED, CAR.KIA_CEED_SW_PHEV_2022_NON_SCC,
                         CAR.KIA_CEED_SW_PHEV_2022_NON_SCC, CAR.AZERA_6TH_GEN, CAR.AZERA_HEV_6TH_GEN,
                         CAR.CUSTIN_1ST_GEN, CAR.ELANTRA_2022_NON_SCC, CAR.GENESIS_G70_2021_NON_SCC,
